...
class BooksApiTestCase(APITestCase):
    ...
    def test_get(self):
        ...
        self.assertEqual(serializer_data[0]['discount_difference'], '20.00')

    def test_get_for_one(self):
        ...
        serializer_data = BookSerializer(books, many=True).data
        self.assertEqual(status.HTTP_200_OK, response.status_code)
        self.assertEqual(dict(serializer_data[0]), response.data)
    ...
    def test_update(self):
        ...
        self.assertEqual(status.HTTP_200_OK, response.status_code)
        # self.book_1 = Book.objects.get(id=self.book_1.id) - analogue to refresh_from_db()
